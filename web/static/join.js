...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aD, request.L, true);
		} catch (e) {
...
var $author$project$Join$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Join$messageReceived($author$project$Join$Recv),
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{as: false, au: r.au, ay: r.ay, S: r.S, aD: r.aD, aO: r.aO, am: r.am, L: r.L}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{au: r.au, ay: r.ay, S: _List_Nil, aD: 'POST', aO: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing, L: r.L});
};
			...
			switch (msg.$) {
				...
				case 3:
					...
					if (!response.$) {
						...
						var $temp$msg = $author$project$Join$JoinPresentation(joinPresentationResponse.L),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Join A Presentation')
							])),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
...
var $author$project$Join$main = $elm$browser$Browser$element(
	{aC: $author$project$Join$init, aN: $author$project$Join$subscriptions, aQ: $author$project$Join$update, aR: $author$project$Join$view});
