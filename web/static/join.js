...
var $author$project$Join$init = function (_v0) {
	return _Utils_Tuple2(
		{error: '', registration_key: '', state: $author$project$Join$Disconnected, title: 'Please Join A Presentation'},
...
var $author$project$Join$newSlideMessageDecoder = A2(
...
var $author$project$Join$initialPresentationDataMessageDecoder = A2(
	...
	A3(
		...
		A2(
			$elm$json$Json$Decode$field,
			'settings',
			$elm$json$Json$Decode$maybe($author$project$Join$newSlideMessageDecoder))));
		...
		while (true) {
			switch (msg.$) {
						...
						$elm$http$Http$post(
							{
								...
								expect: A2($elm$http$Http$expectJson, $author$project$Join$GotWebsocketAddress, $author$project$Join$joinPresentationResponseDecoder),
								url: '/join'
				...
				case 'ReceivedWebsocketMessage':
					...
					if (_v2.$ === 'Ok') {
						if (_v2.a.$ === 'InitialPresentationDataMessage') {
